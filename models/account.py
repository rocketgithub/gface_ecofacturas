    ...
    def invoice_validate(self):
        ...
        for factura in self:
            if factura.journal_id.nit_emisor_gface and not factura.firma_gface:
                ...
                if factura.factura_original_id:
                    TDFEPNum.text = int(factura.factura_original_id.name.split("-")[4][2:])
                else:
                    TDFEPNum.text = "0"
...
class AccountJournal(models.Model):
    ...
    tipo_documento_gface = fields.Selection([('FACE-63', 'FACE-63'), ('FACE-66', 'FACE-66'), ('NCE-64', 'NCE-64'), ('NDE-65', 'NDE-65')], 'Tipo de Documento GFACE', copy=False)
